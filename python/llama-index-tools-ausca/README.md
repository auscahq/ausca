...
LlamaIndex tools that pay for HTTP 402 APIs over
...
other x402 v2 resource works the same way: point `url` at it. The LangChain
sibling is [`langchain-ausca`](https://pypi.org/project/langchain-ausca/).
