"""LangChain tools that pay for HTTP 402 APIs over x402.
...
the request; the caller's key and hard per-call USD cap stay outside the
model's reach.
"""
...
from langchain_ausca._payable import (
    PayableCallError,
    PayableCaller,
    PayableCallResult,
    PaymentReceipt,
...
def payable_tool(
    *,
    ...
    """Build a LangChain structured tool over one x402 payable resource.
